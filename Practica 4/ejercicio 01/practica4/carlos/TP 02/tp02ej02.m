clear all; close all;
RN = [8 8];                        % red neuronal [cant. filas,cant. columnas]
k = 8;                              % cantidad de particiones para k folding
epochs = [20 50 30];                % cantidad de épocas por etapa de entrenamiento
...
file = 'te.csv';                    % ruta del archivo de datos
